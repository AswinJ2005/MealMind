...
// ---- IMPORTANT ----
// We are bringing the controller logic directly into this file
// to rule out any import/require issues.
const pool = require('../config/database');

const { verifyFirebaseToken } = require('../middleware/auth.middleware');

// APPLY THE MIDDLEWARE GATEKEEPER
router.use(verifyFirebaseToken);


// === DEFINE THE ROUTES AND THEIR LOGIC DIRECTLY ===
...
router.put('/me', async (req, res) => {
    try {
        ...
        const query = `
            UPDATE users SET display_name = $1, age = $2, weight_kg = $3, height_cm = $4, activity_level = $5, fitness_goal = $6, updated_at = NOW()
